...
import emoji1 from "../../assets/gif3.gif"
    ...
    <div className={classes.container}>
      ...
      <form className={classes.form_container} onSubmit={onSubmit}>
        ...
        <div className={classes.title_container}>
          <p className={classes.title}>Welcome OnBoard </p>
          <span className={classes.subtitle}>Get started with Listy, just create an account and enjoy the experience.</span>
        </div>
        <br/>
        <div className={classes.input_container}>
          <label className={classes.input_label} for="email_field">Email</label>
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className={classes.icon}>
          ...
          <input placeholder="name@mail.com" title="Input title" name="input-name" type="text" className={classes.input_field} id="email_field" onChange={(e)=>setEmail(e.target.value) }/>
        </div>
        <div className={classes.input_container}>
          <label className={classes.input_label} for="email_field">Username</label>
          <img src={user} height="24" width="24" viewBox="0 0 24 24" className={classes.icon} alt="" />
          <input placeholder="UserName" title="Input title" name="input-name" type="text" className={classes.input_field} id="name_field" onChange={(e)=>setName(e.target.value)}/>
        </div>
        <div className={classes.input_container}>
          <label className={classes.input_label} for="password_field">Password</label>
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className={classes.icon}>
          ...
          <input placeholder="Password" title="Input title" name="input-name" type="password" className={classes.input_field} id="password_field" onChange={(e)=>setPassword(e.target.value)} />
        </div>
